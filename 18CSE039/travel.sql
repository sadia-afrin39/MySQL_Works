...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2019 at 02:45 PM
...
INSERT INTO `book_ticket` (`t_id`, `passenger_id`, `bus_id`, `ar_id`, `journey_date`, `seat_no`) VALUES
...
INSERT INTO `driver` (`d_id`, `name`, `gender`, `email`, `phone`) VALUES
(1, 'Habib', 'male', 'habib@gmail.com', '0198398409'),
(2, 'Kamal', 'male', 'kamal@gmail.com', '01374577567'),
(3, 'Nabab', 'male', 'nabab@gmail.com', '01983984409'),
(4, 'Kamal', 'male', 'kamal@gmail.com', '01374877567');
...
INSERT INTO `passenger` (`p_id`, `name`, `gender`, `email`, `phone`) VALUES
(1, 'nasir', 'male', 'nasir@gmail.com', '01900987654'),
(2, 'azim', 'male', 'azim@gmail.com', '09876262636'),
(3, 'bina', 'female', 'bina@gmail.com', '01933987654'),
(4, 'aslam', 'male', 'aslam@gmail.com', '09876262636');
...
ALTER TABLE `book_ticket`
  ...
  ADD CONSTRAINT `book_ticket_ibfk_3` FOREIGN KEY (`ar_id`) REFERENCES `assign_route` (`ar_id`);
COMMIT;
